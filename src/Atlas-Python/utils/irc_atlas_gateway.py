...
try:
    ...
    print("Get irclib from http://sourceforge.net/projects/python-irclib/", end='')
...
class IRC_Client:
    ...
    def on_connect(self, connection, event):
        ...
        print(connection.join(self.channel), end='')
...
class AtlasClient(TcpClient):
    ...
    def sound_op(self, op):
        ...
        if hasattr(talk_op, "id") and talk_op.id=="gateway":
            print("initially from IRC, not shown again", end='')
        else:
